...
% Bottom right
subplot(4,4,[10,14])
plot(t_W_C_all(1,1:curr_frame_idx), t_W_C_all(2,1:curr_frame_idx), 'color', 'b'), grid off, axis equal
...
% plot(trackedLandmarksOverLast20Frames{end}(1,:), trackedLandmarksOverLast20Frames{end}(2,:), 'ks', 'MarkerSize', 6,...
%     'MarkerFaceColor',[0,0,0])
