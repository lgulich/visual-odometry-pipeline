...
[F, kp_inliers_idx, status] = estimateFundamentalMatrix( ...
                                ...
                                'Method','RANSAC', ...
                                'NumTrials', params.eightp_num_trials, ...
                                'DistanceThreshold', params.eightp_dist_threshold, ...
                                'Confidence', params.eightp_confidence);
...
[R, T, valid_points_fraction] = relativeCameraPose(F, params.cam, ...
